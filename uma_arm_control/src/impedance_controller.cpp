    ...
    */
    ...
    private:
        ...
        void update_jacobians()
        {
            ...
            // Calculate J'(q, q')
            jacobian_derivative_ << -l1_ * cos(q1) * dq1 - l2_ * cos(q1 + q2) * dq1,  -l2_ * cos(q1 + q2) * dq2,
                                    -l1_ * sin(q1) * dq1 - l2_ * sin(q1 + q2) * dq1,  -l2_ * sin(q1 + q2) * dq2;
        ...
        Eigen::VectorXd calculate_desired_joint_accelerations()
        {
            ...
            Eigen::VectorXd x_ddot = desired_cartesian_accelerations_;


            Eigen::VectorXd q_ddot = jacobian_.inverse() * (x_ddot - jacobian_derivative_ * joint_velocities_);
